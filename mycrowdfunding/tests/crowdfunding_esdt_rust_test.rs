...
where
    CrowdfundingObjBuilder: 'static + Copy + Fn() -> mycrowdfunding::ContractObj<DebugApi>,
{
    ...
    pub cf_wrapper:
        ContractObjWrapper<mycrowdfunding::ContractObj<DebugApi>, CrowdfundingObjBuilder>,
}
...
#[test]
fn init_test() {
    let cf_setup = setup_crowdfunding(mycrowdfunding::contract_obj);
    cf_setup
        .blockchain_wrapper
...
#[test]
fn fund_test() {
    let mut cf_setup = setup_crowdfunding(mycrowdfunding::contract_obj);
